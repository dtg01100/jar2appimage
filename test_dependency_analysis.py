...
try:
    ...
    from jar2appimage.dependency_graph import (
        Dependency,
        DependencyScope,
        DependencyType,
        Platform,
    )
    from jar2appimage.dependency_resolver import (
        DependencyResolver,
        ResolutionContext,
        ResolutionResult,
    )
    from jar2appimage.jar_analyzer import (
        JarAnalysisResult,
        JarAnalyzer,
        analyze_jar_file,
    )
